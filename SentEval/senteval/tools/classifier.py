...
class PyTorchClassifier(object):
    ...
    def fit(
        self, X, y, validation_data=None, validation_split=None, early_stop=True
    ):
        self.nepoch = 0
        bestaccuracy = -1
        stop_train = False
...
class MLP(PyTorchClassifier):
    def __init__(
        ...
        self.epoch_size = (
            4 if "epoch_size" not in params else params["epoch_size"]
        )
        ...
        self.batch_size = (
            64 if "batch_size" not in params else params["batch_size"]
        )
